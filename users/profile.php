...
// Preia înregistrrile utilizatorului
$my_registrations = [];
$stmt = $conn->prepare("
            ...
            <div class="col-md-8">
                ...
                <div class="bg-white p-4 rounded shadow mb-4">
                    ...
                    <?php if (empty($my_events)): ?>
                        <p class="text-muted">Nu ai creat înc niciun eveniment.</p>
                    <?php else: ?>
                ...
                <!-- Înregistrri la evenimente -->
                <div class="bg-white p-4 rounded shadow">
                    <h4 class="mb-3">Înregistrrile mele</h4>

                    <?php if (empty($my_registrations)): ?>
                        <p class="text-muted">Nu eti înscris la niciun eveniment.</p>
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
